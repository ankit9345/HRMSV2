...
interface AskForHrSidebarProps {
  isOpen: boolean
  onClose: () => void
  activePage?: string
}
...
export function AskForHrSidebar({ isOpen, onClose, activePage = "incident" }: AskForHrSidebarProps) {
  return (
    <>
      {/* Mobile overlay */}
      {isOpen && (
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-sidebar-border bg-muted px-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-primary">Ask for HR</span>
            </div>
            <div className="flex items-center gap-2">
